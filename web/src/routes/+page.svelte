        ...
        <section>
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-2">
                    <button
                        onclick={() => prevSlide()}
                        class="w-8 h-8 rounded-full bg-zinc-800 hover:bg-zinc-700 flex items-center justify-center"
                    >
                        <ChevronLeft size={16} />
                    </button>
                    <button
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {#each recentPlays.slice(currentSlide * 9, (currentSlide + 1) * 9) as song (song.id)}
                        <button
                            ...
                            class="flex items-center gap-3 p-3 rounded-lg bg-zinc-900/50 hover:bg-zinc-800 group text-left"
                        >
                            <img
